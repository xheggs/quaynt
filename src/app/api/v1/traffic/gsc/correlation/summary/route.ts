...
import { getCorrelationSummary } from '@/modules/integrations/gsc-correlation/gsc-correlation.service';
    ...
    withAuth(
      withRateLimit(
        withScope(async (req) => {
          ...
          const summary = await getCorrelationSummary(auth.workspaceId, parsed.data);
