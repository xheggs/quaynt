...
import { getTopPages } from '@/modules/crawler/crawler-analytics.service';
import type { BotCategory } from '@/modules/crawler/crawler.types';

// GET /api/v1/crawler/analytics/top-pages — most crawled pages
    ...
    withAuth(
      withRateLimit(
        withScope(async (req) => {
          ...
          const pages = await getTopPages(auth.workspaceId, filters, Math.min(limit, 100));
