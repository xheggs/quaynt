...
export const WEBHOOK_SAMPLE_PAYLOADS: Record<WebhookEventType, object> = {
  ...
  'gsc.sync_completed': {
    gscSync: {
      workspaceId: 'ws_sample123',
      gscConnectionId: 'gscconn_sample456',
  ...
  'query_fanout.extracted': {
    modelRunId: 'run_sampleabc',
    modelRunResultId: 'runres_sample789',
    platformId: 'gemini',
    promptId: 'prompt_sample123',
    insertedNodes: 14,
    rootNodes: 1,
    subQueryNodes: 3,
    sourceNodes: 10,
  ...
  'visibility.geo_score_computed': {
    geoScore: {
      ...
      formulaVersion: 1,
      contributingPromptSetIds: ['ps_sample456'],
      factors: [
        {
          ...
          weight: 25,
          status: 'active',
          inputs: { sharePercentage: 25, totalCitations: 120 },
        },
        {
          id: 'source_diversity',
          score: 72.3,
        ...
        },
        {
          ...
          weight: 15,
          status: 'active',
          inputs: { netSentimentScore: 0.5, totalCitations: 120 },
        },
        {
        ...
        },
        {
          ...
          weight: 10,
          status: 'active',
          inputs: { observedPairs: 4, expectedPairs: 5, expectedSource: 'promptSetConfig' },
        },
      ],
      computedAt: '2026-05-01T05:00:00.000Z',
    },
  },
  'visibility.seo_score_computed': {
    seoScore: {
      ...
      factors: [
        {
          id: 'impression_volume',
          score: 50,
          weight: 25,
          status: 'active',
          inputs: { impressions: 25000, querySetSize: 24 },
        },
        {
          ...
          weight: 25,
          status: 'active',
          inputs: { impressionWeightedCtr: 0.18, totalImpressions: 25000 },
        },
        {
          id: 'rank_quality',
          score: 72,
          weight: 30,
          status: 'active',
          inputs: { impressionWeightedPosition: 6.2, totalImpressions: 25000 },
        },
        {
          id: 'aio_presence',
          score: 92,
          weight: 20,
          status: 'active',
          inputs: { aioMatchedCount: 22, querySetSize: 24 },
        },
      ],
      computedAt: '2026-05-01T07:00:00.000Z',
    },
  },
  'webhook.test': {
    test: true,
